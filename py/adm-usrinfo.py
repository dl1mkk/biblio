...
h = hh.apphtml()
#
h001 = { "title":"BIBLIOTHEK CHIARA & PIER CARLO RABINO", "sub":"Benutzer Information", "back":"adm-user.php", "help":"help.php" }
t001 = { "class":"left", "width":"80%" }
t002 = { "class":"center", "width":"80%" }
b001 = { "check":"self", "send":"adm-usrinfo1.php", "tabindex":"96" }
#
...
p012 = { "class":"right", "width":"20%", "prompt":"Land : " }
p013 = { "class":"right", "width":"20%", "prompt":"Landvorwahl : " }
...
i001 = { "tdclass":"left", "tdwidth":"80%", "input":"on", "type":"text", "class":"fixreq", "name":"username",
         "value":"<?php echo $username; ?>", "readonly":"yes", "autofocus":"on", "tabindex":"1" }
...
i014 = { "tdclass":"left", "tdwidth":"80%", "input":"on", "type":"tel", "class":"fixreq", "size":"30",
         "name":"telefon", "value":"<?php echo $telefon; ?>", "required":"yes", "tabindex":"16" }

i015 = { "tdclass":"left", "tdwidth":"80%", "input":"on", "type":"mail", "class":"fixreq", "size":"64",
         "name":"mail", "value":"<?php echo $mail; ?>", "required":"yes", "tabindex":"17" }

i016 = { "tdclass":"left", "tdwidth":"80%", "input":"on", "type":"text", "class":"fix",
         "name":"land", "value":"<?php echo $land; ?>", "size":"40", "readonly":"yes", "tabindex":"14" }
      
i017 = { "tdclass":"left", "tdwidth":"80%", "input":"on", "type":"text", "class":"fix",
         "name":"landvorwahl", "value":"<?php echo $landvorwahl; ?>", "size":"10", "readonly":"yes", "tabindex":"15" }
#
h.prolog(title="USRINFO")
h.Header(defh=h001)
h.include("php/adm-usrinfo-p01.php")
#
# Enter Page contents here
h.Form_Self()
h.Table(deft=t001)
#
h.Line(t001,p001,i001,file,"78")
h.Line(t001,p002,i002,file,"79")
h.Line(t001,p003,i003,file,"80")
h.Line(t001,p004,i004,file,"81")
h.Line(t001,p005,i005,file,"82")
h.Line(t001,p006,i006,file,"83")
h.Line(t001,p007,i007,file,"84")
h.Line(t001,p008,i008,file,"85")
...
h.out('</td>')
h.Row_End()
h.Line(t001,p012,i016,file,"99")
h.Line(t001,p013,i017,file,"100")
h.Line(t001,p014,i014,file,"101")
h.Line(t001,p015,i015,file,"102")
#
h.Table_End()
h.Table(deft=t002)
